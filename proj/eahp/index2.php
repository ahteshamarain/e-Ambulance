      ...
      <tr>
        ...
        <td>
          <select class="form-control" id="status" name="status" required>
            ...
            <?php if (isset($_SESSION['driverid'])): ?>
              <!-- Driver only sees Accept or Reject -->
              <option value="Assigned">Accept</option>
              <option value="Rejected">Reject</option>
            <?php elseif (isset($_SESSION['eahpaid'])): ?>
              <!-- Admin sees full options -->
              <?php if ($pstatus == ""): ?>
            ...
            while ($row3 = mysqli_fetch_array($query)) { ?>
              <option value="<?php echo $row3['AmbRegNum'];?>">
                ...
                if ($atype == "1") {
                  ...
                  echo "Non-Emergency Patient Transport Ambulances";
                } elseif ($atype == "4") {
                  echo "Boat Ambulance";
