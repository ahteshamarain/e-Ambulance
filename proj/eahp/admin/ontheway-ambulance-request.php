    ...
    <div>
      <table class="table table-bordered">
        ...
        if (isset($_SESSION['eahpaid']) && $_SESSION['eahpaid'] != "") {
            ...
            $ret = mysqli_query($con, "SELECT * FROM tblambulancehiring WHERE Status = 'On the Way'");
            ...
            $ret = mysqli_query($con, "SELECT * FROM tblambulancehiring WHERE AmbulanceRegNo = '$ambRegNum' AND Status = 'On the Way'");
        }
        $cnt = 1;
        ...
        <tbody>
          <tr>
            ...
            <td><span class="badge badge-primary">On the Way</span></td>
