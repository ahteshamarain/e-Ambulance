    ...
    <div>
      <table class="table table-bordered">
        ...
        if (isset($_SESSION['eahpaid']) && $_SESSION['eahpaid'] != "") {
            ...
            $ret = mysqli_query($con, "SELECT * FROM tblambulancehiring WHERE Status = 'reached'");
            ...
            $ret = mysqli_query($con, "SELECT * FROM tblambulancehiring WHERE AmbulanceRegNo = '$ambRegNum' AND Status = 'reached'");
        }
        $cnt = 1;
