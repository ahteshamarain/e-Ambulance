...
if (strlen($_SESSION['eahpaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($result > 0) {
            echo "<script>alert('This ambulance is already registered');</script>";
        } else {
            // Hash the password using md5()
            $hashed_pass = md5($dcpass);  // Use md5 for password hashing

            // Insert the data with the md5 hashed password
            $query = mysqli_query($con, "INSERT INTO tblambulance(AmbulanceType, AmbRegNum, DriverName, DriverContactNumber, Ablemail, Ablpass) 
            VALUES('$ambulancetype', '$ambregnum', '$dname', '$dconnum', '$dcemail', '$hashed_pass')");
		...
		<div class="form-w3layouts">
            ...
            <div class="row">
                ...
                <option value="4">Boat Ambulance</option>
                                    ...
                                    <div class="form-group ">
                                        <label for="ablemail" class="control-label col-lg-3">Driver Username</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="dconnum" name="dcemail" type="text" required="true" value="">
                                            
                                        </div>
                                        
                                    </div>
                                    <div class="form-group ">
                                        <label for="adminname" class="control-label col-lg-3">Driver Password</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="dconnum" name="dcpass" type="password" required="true" value="">
