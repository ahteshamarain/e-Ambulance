    ...
    <div>
      ...
      <?php
        ...
        if (isset($_SESSION['eahpaid']) && $_SESSION['eahpaid'] != "") {
            ...
            $ret = mysqli_query($con, "SELECT * FROM tblambulancehiring WHERE Status = 'Assigned'");
            ...
            $ret = mysqli_query($con, "SELECT * FROM tblambulancehiring WHERE AmbulanceRegNo = '$ambRegNum' AND Status = 'Assigned'");
        }
        $cnt = 1;
